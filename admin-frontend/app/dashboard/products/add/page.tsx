...
import { productsApi, productCategoriesApi, uploadApi, Category } from "@/lib/api";
    ...
    <DashboardLayout title="Add Product">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-semibold text-admin-800">Add New Product</h2>
            <p className="text-admin-600">Fill in the details to create a new product</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="card p-6 space-y-4">
            ...
            <div className="border-2 border-dashed border-admin-300 rounded-lg p-6">
              <input
                ...
                onChange={handleImageUpload} className="hidden" id="image-upload" disabled={uploading}
              />
              <label htmlFor="image-upload" className="flex flex-col items-center cursor-pointer">
                <Upload className="w-8 h-8 text-admin-400 mb-2" />
                <span className="text-sm text-admin-600">{uploading ? "Uploading..." : "Click to upload images"}</span>
                <span className="text-xs text-admin-500 mt-1">PNG, JPG, WEBP up to 5MB</span>
              </label>
            </div>
          ...
          <div className="card p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text" value={formData.origin}
          ...
          <div className="card p-6 space-y-4">
            ...
            <div className="w-48">
              ...
              <input
                type="number" min="0" value={formData.displayOrder}
