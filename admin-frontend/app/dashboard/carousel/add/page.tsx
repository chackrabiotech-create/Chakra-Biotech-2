...
const AddCarouselPage = () => {
  ...
  return (
    <DashboardLayout title="Add Carousel Slide">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-semibold text-admin-800">Add New Carousel Slide</h2>
            <p className="text-admin-600">Create a new homepage carousel slide</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="card p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text" value={formData.secondaryCtaText}
              ...
              <div>
                ...
                <input
                  type="text" value={formData.secondaryCtaLink}
          ...
          <div className="card p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  type="number" min="1" value={formData.displayOrder}
              ...
              <div>
                ...
                <input
                  type="number" min="0" max="1" step="0.1" value={formData.overlayOpacity}
          ...
          <div className="flex justify-end gap-4">
            <button
              type="button" onClick={() => router.push("/dashboard/carousel")}
