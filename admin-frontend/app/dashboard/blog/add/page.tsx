...
import { blogsApi, blogCategoriesApi, Category } from "@/lib/api";
    ...
    <DashboardLayout title="Add Blog Post">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-semibold text-admin-800">Create New Blog Post</h2>
            <p className="text-admin-600">Fill in the details below to publish a new article</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="card p-6 space-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="isPublished" className="text-sm font-medium text-admin-700">Publish Immediately</label>
            </div>
          </div>
